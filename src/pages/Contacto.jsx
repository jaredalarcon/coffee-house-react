...
function Contacto() {
  ...
  return (
    <div className="bg-white py-16 px-4 max-w-xl mx-auto">
      <h2 className="text-3xl font-bold text-gray-800 text-center mb-4">Contacto</h2>
      <p className="text-gray-600 text-center mb-8">¿Deseas café al por mayor para tu negocio? Escríbenos.</p>
